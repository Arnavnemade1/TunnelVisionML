    ...
    if mode == "Upload Data":
        ...
        if uploaded_file is not None:
            if uploaded_file.type == "text/plain":
                ...
                barrier_df = pd.DataFrame()  # Empty DataFrame for CSV input
        ...
        if st.button("Run Advanced Analysis"):
            ...
            if len(tunneling_prob) > 0 and len(no_tunneling_prob) > 0:
                ...
                st.warning("Not enough data to perform Kolmogorov-Smirnov Test. Ensure both tunneling and non-tunneling events are present.")
